...
export default function CardLogin(props) {
    ...
    return(
        <>{hide ? (<></>):(<>{btnHide ? (<>
            ...
            <div id="divClick" className="w-full h-full z-30 bg-secondary-dark opacity-70"></div>
            ...
            <div className="p-2 w-1/3 h-max bg-white rounded-lg z-30 fixed">
                ...
                <div className="p-1 mt-2">
                    <form id="formRegister">
                        ...
                        <div className="mt-3 p-1 flex flex-col w-full bg-secondary-light rounded-lg">
                            <Input type="text" label="Apellidos" placeholder="Apellidos" color="secondary-light"/>
                        </div>
                        <SimpleDate
