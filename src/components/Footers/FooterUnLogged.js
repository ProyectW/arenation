    ...
    <div className="px-8 md:px-12 flex flex-col items-center w-full bg-primary-800 text-white">
      <div className="flex items-center">
        <h1 className="py-12 text-center">
          Reserva escenarios deportivos desde cualquier lugar y en cualquier
          momento
        </h1>
      </div>
      ...
      <div className="w-full flex flex-col md:flex-row items-center py-12">
        ...
        <div className="md: w-1/3 flex justify-center md:justify-end">
          <a href="http://www.facebook.com">
            <img src={LogoFacebook} alt="Facebook Logo" className="p-2" />
          </a>
          <a href="http://www.instagram.com">
            <img src={LogoInstagram} alt="Instagram Logo" className="p-2" />
          </a>
          <a href="http://www.twitter.com">
            <img src={LogoTwitter} alt="Twitter Logo" className="p-2" />
          </a>
        </div>
      </div>
    </div>
