  ...
  return (
    <div className="px-8 py-16 sm:px-16 flex flex-col">
      ...
      <div className="flex flex-col md:flex-row md:justify-between pt-9">
        ...
        >
          <Link to="/arenas/city/San Pelayo">
            <div className="p-4 text-white cursor pointer">
      ...
      >
        <div className="w-full md:w-1/3 flex flex-col ">
          <h2 className="text-white pb-4 text-2xl md:text-3xl">
            Juega de local y gestiona tu escenario de forma inteligente
          </h2>
          <p className="text-white pb-4">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam,
            porro omnis eligendi sed tempore, necessitatibus officia ad
            corporis, sit modi commodi facilis. necessitatibus officia ad
            corporis, sit modi commodi facilis.
          </p>
          <Button
            type="normal"
